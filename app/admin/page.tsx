        ...
        <div className="bg-[#0b3663] text-white p-4 sm:p-6 border-l-4 border-[#00a8e8] flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
          <div>
            ...
            <p className="text-xs text-slate-300 mt-1 max-w-xl leading-relaxed">
              Manage tour packages, visa countries, services, homepage destinations, and live customer inquiries connected to Neon PostgreSQL & Cloudinary CDN.
            </p>
          </div>
                  ...
                  {recentInquiries.map((inq: any) => {
                    ...
                    return (
                      <tr key={inq.id} className="hover:bg-slate-50 transition-colors">
                        <td className="py-3 px-3 sm:px-4 font-mono text-slate-500 text-[11px]">
                        ...
                        <td className="py-3 px-3 sm:px-4 text-right">
                          {whatsappUrl ? (
                            <a
                              ...
                              className="inline-flex items-center space-x-1 px-2.5 py-1 bg-emerald-600 text-white hover:bg-emerald-700 font-bold uppercase text-[10px] transition-colors shadow-2xs"
                            >
